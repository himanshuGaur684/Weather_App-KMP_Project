...
import gaur.himanshu.weatherapp.data.utils.DataUtils
        ...
        setContent {
            MyApplicationTheme {
                Surface(
                    ...
                    WeatherApp(modifier = Modifier.fillMaxSize(), viewModel = viewModel)
                }
            }
        }
    }
...
fun WeatherApp(modifier: Modifier = Modifier, viewModel: WeatherViewModel) {
    ...
    Column(
        ...
        uiState.data?.let { response ->
            ...
            GlideImage(
                imageModel = DataUtils.getImageUrl(response.icon),
                modifier = Modifier
                    .width(200.dp)
                    .height(100.dp),
            ...
            LazyColumn {
                ...
                items(response) { item ->
                    Row(
                        ...
                        Spacer(modifier = Modifier.weight(1f))
                        GlideImage(
                            imageModel = DataUtils.getImageUrl(
                                item.icon
                            ),
